...
namespace UnityEngine.Tilemaps
{
    ...
    public class AnimatedTile : TileBase
    {
        ...
        public enum PlayMode { Loop, Trigger };
         ...
         ref TileAnimationData tileAnimationData)
        {
            ...
            bool shouldPlay =
                ...
                (playMode == PlayMode.Trigger && triggerPlay);
            ...
            tileAnimationData.flags = playMode == PlayMode.Loop
                ? TileAnimationFlags.None
                : TileAnimationFlags.LoopOnce;  // ne boucle qu'une fois

            // Conservation de l’option m_AnimationStartFrame
            if (0 < m_AnimationStartFrame && m_AnimationStartFrame <= m_AnimatedSprites.Length)
            {
                var tmComp = tilemap.GetComponent<Tilemap>();
                if (tmComp != null && tmComp.animationFrameRate > 0)
                    tileAnimationData.animationStartTime =
                        (m_AnimationStartFrame - 1) / tmComp.animationFrameRate;
            }
